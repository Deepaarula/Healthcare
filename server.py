...
# Then, apply CORS to the initialized app object.
...
def normalize_requirement():
    ...
    iso_prompt = (
        ...
        "req_id, test_case_id, compliant (true/false), missing_elements (string), "
        "related_iso_refs (string), suggestions (string).\n\n"
